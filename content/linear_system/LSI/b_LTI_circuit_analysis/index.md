...
이 결과는 **위에서 풀이한 결과와 다름**을 확인할 수 있다. 앞선 챕터의 내용들을 상기해보자. **임펄스 응답을 사용하여 시스템의 출력을 구하려면, 시스템이 LTI 여야 한다는 전제조건이 있어야 한다.** 그러나, 위 회로는 초기값이 존재함으로, LTI 시스템이 아니다.
