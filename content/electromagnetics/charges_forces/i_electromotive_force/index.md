...
하지만,  **전하(또는 도체)와 함께 움직이는 관측자의 관점에서 보면, 장의 방정식은 다르게 보인다**. 이 움직이는 관측자는 자신에게 정지해 있는 전하가 자기장 내에서 자기력을 받지 않는다고 생각한다. 대신, 상대적인 움직임으로 인해 전기장과 자기장이 서로 혼합되어 새로운 형태의 장(E′,H′ )을 경험하게 된다.
