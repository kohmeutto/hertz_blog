...
매크로니 급수의 전개를 미분연산자에 사용한다. 특수해의 차수보다 높은 차수의  연산자는 소거된다.
<br><br>
...
\\
&y_{p}=\operatorname{}\frac{1}{D\left(1+D\right)}2x=\int_{x=x'}dx'\left\lbrack\left(1-D\right)2x'\right\rbrack=\int_{x=x'}dx'\left\lbrack2x'-2\right\rbrack=x^2-2x
\end{aligned}
$$
{{< /details >}}
...
\\
&y_{p}=\operatorname{}\frac{1}{D\left(D-3\right)}x=\int_{x=x'}dx'\left\lbrack-\frac13\left(1+\frac13D\right)x'\right\rbrack=\int_{x=x'}dx'\left\lbrack-\frac13x'-\frac19\right\rbrack \\
&=-\frac16x^2-\frac19x
\end{aligned}
$$
{{< /details >}}