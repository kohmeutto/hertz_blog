...
$$
A_{ij}'=\langle u'_i|u_k\rangle\langle u'_j|u_l\rangle A_{kl}
$$

이번에는 역변환을 생각해 보자.

$$
A_{ij}=\langle u_i|u'_k\rangle\langle u_j|u'_l\rangle A_{kl}'
$$
...
A_{ij}'
=\langle u_i'|\bar{\bar{A}}|u_j'\rangle
=\langle u_i'|u_k\rangle A_{kl} \langle u_l |u_j'\rangle 
$$
